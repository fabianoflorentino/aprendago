...
func Menu(args []string) {
	...
	options := map[string]func(){
		...
		"--na-pratica-exercicio-10 --nivel-3":             func() { exercicios_ninja_nivel_3.NaPraticaExercicio10() },
		"--na-pratica-exercicio-10 --nivel-3 --resolucao": func() { exercicios_ninja_nivel_3.ResolucaoNaPraticaExercicio10() },
