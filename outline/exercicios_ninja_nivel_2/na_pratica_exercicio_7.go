...
func RespondaAProva() {
	questionario := []format.Questionario{
		{Numero: "1.", Pergunta: "Ao utilizar o opeardor curto de declaração, não é necessário especificar o tipo", Opcoes: opcaoVerdadeiroFalso},
		{Numero: "2.", Pergunta: "Uma variável do tipo bool pode conter três valores: true, false, undefined", Opcoes: opcaoVerdadeiroFalso},
		{Numero: "3.", Pergunta: "Se você tiver 5 lâmpadas na varanda, pode codificar quantas mensagens?", Opcoes: []string{"16", "32", "64", "128", "256"}},
		{Numero: "4.", Pergunta: "Bit é uma abreviação de Binary Digit", Opcoes: opcaoVerdadeiroFalso},
		{Numero: "5.", Pergunta: "On e Off, notação binária, linguagem de máquina, bits, etc., todos referem-se à idéia de que em computadores no fim das contas tudo se resume a zeros e uns", Opcoes: opcaoVerdadeiroFalso},
		...
		{Numero: "9.", Pergunta: "Em Go, rune é um 'apelido' para float64", Opcoes: opcaoVerdadeiroFalso},
		{Numero: "10.", Pergunta: "Em Go, byte é um 'apelido' para float64", Opcoes: opcaoVerdadeiroFalso},
		{Numero: "11.", Pergunta: "Ao usar o tipo int, o compilador irá decidir se vai usar int32 ou int64 dependendo da arquitetura do sistema em questão", Opcoes: opcaoVerdadeiroFalso},
		{Numero: "12.", Pergunta: "Uma string é uma sequência de bytes, também chamada de *fatia de bytes", Opcoes: opcaoVerdadeiroFalso},
		{Numero: "13.", Pergunta: "O código fonte de Go é sempre UTF-8", Opcoes: opcaoVerdadeiroFalso},
		{Numero: "14.", Pergunta: "Cada caractere de uma string é um 'rune'", Opcoes: opcaoVerdadeiroFalso},
		{Numero: "15.", Pergunta: "Via de regra, para tipos numéricos devemos usar float64 para números inteiros, e int para números 'com virgula'", Opcoes: opcaoVerdadeiroFalso},
